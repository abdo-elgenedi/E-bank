      ...
      <div class="px-4">
        ...
        <div class="table-wrapper">
          <!--Table-->
            ...
            <tr>
                <td><a href="{{route('admin.transactions.transactionsbyid',$transaction->sender_id)}}">{{$transaction->sender_id}}</a></td>
              <td>{{$transaction->senders->name}}</td>
                <td><a href="{{route('admin.transactions.transactionsbyid',$transaction->receiver_id)}}">{{$transaction->receiver_id}}</a></td>
